"""
********************************************************************
* Author = https://github.com/CD-AC                                *
* Date = '25/03/2024'                                              *
* Description = Streamlit App - Gas_Station_Geolocation            *
********************************************************************
"""
...
from utils import GetLatLon2_google,cal_dist,distance_estac,transform_df_map,marker_rest
from streamlit_folium import folium_static

image = Image.open('Fuel.webp')

st.sidebar.image(image , caption="Gas Station Geolocation App",width = 256)
app_mode = st.sidebar.selectbox("Choose app mode", ["Run App","About Me"])


if app_mode == 'Run App':

    st.title('Gas Station Geolocation App')
